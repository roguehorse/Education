Public Class Form1
    ...
    'an enhanced home utility auditing program based on Week 2
    '***************************************
    ...
    Private Sub btnAddToList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddToList.Click
        ...
        Else
            ...
            txtItemList.Items.Add(cboxAppliances.Text)

            'Add value in kW Rating to list
            txtHoursUsedList.Items.Add(txtHoursUsed.Text)

            'Add value in kW Rate Per Hour to list
            txtCostList.Items.Add(txtTotalCost.Text)

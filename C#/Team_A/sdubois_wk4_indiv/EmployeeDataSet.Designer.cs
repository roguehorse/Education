...
namespace sdubois_wk4_indiv {
    ...
    public partial class EmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow AddEmployeesRow(string FirstName, string LastName, string City, string State, string Email, string Title, string Username, string Password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeesRow FindByPersonID(int PersonID) {
...
namespace sdubois_wk4_indiv.EmployeeDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employees] ([FirstName], [LastName], [City], [State], [Email], [Title], [Username], [Password]) VALUES (@FirstName, @LastName, @City, @State, @Email, @Title, @Username, @Password);
SELECT PersonID, FirstName, LastName, City, State, Email, Title, Username, Password FROM Employees WHERE (PersonID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [FirstName] = @FirstName, [LastName] = @LastName, [City] = @City, [State] = @State, [Email] = @Email, [Title] = @Title, [Username] = @Username, [Password] = @Password WHERE (([PersonID] = @Original_PersonID) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([City] = @Original_City) AND ([State] = @Original_State) AND ([Email] = @Original_Email) AND ([Title] = @Original_Title) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password));
SELECT PersonID, FirstName, LastName, City, State, Email, Title, Username, Password FROM Employees WHERE (PersonID = @PersonID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::sdubois_wk4_indiv.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PersonID, FirstName, LastName, City, State, Email, Title, Username, Passwo" +
                "rd FROM dbo.Employees";
        ...
        public virtual int Delete(int Original_PersonID, string Original_FirstName, string Original_LastName, string Original_City, string Original_State, string Original_Email, string Original_Title, string Original_Username, string Original_Password) {
        ...
        public virtual int Insert(string FirstName, string LastName, string City, string State, string Email, string Title, string Username, string Password) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_Username, 
                    string Original_Password) {
            return this.Update(FirstName, LastName, City, State, Email, Title, Username, Password, Original_PersonID, Original_FirstName, Original_LastName, Original_City, Original_State, Original_Email, Original_Title, Original_Username, Original_Password, Original_PersonID);
        }
    }
